...
Ari is special, and it is really not fit for everyone. Ari is not a WYSIWYG and you must work with a bit of coding and learning something new as reading some basic TypeScript code and following some instructions. In my previous blog post [Why you should have a personal website?](/blog/why-you-should-have-a-personal-website), [the reason #2](/blog/why-you-should-have-a-personal-website#acquire-new-skills), you must be the type of people who love to learn and experiment new things. In case you are not, but you still want… <!--truncate-->to have a powerful personal website based on Ari, [contact me](../../docs/addons-services) and I will do it for you as a service.

## What Ari benefits you?

### Running Ari is Free

Yes, running Ari is **completely FREE**, `No Hosting Cost`. Or to be professional, you can also buy a domain for your personal website from Cloudflare *(Cloudflare is the first and the best place where you can buy domains with original price, no surplus charging)*
