...
`Latest updates` is one of the most powerful features available in Aris. It helps your visitors to go around and explore all your content easier. You can access this page access http://your-domain.com/latest-updates or click `What's new` icon on the top right of your website.
...
Aris comes with 3 additional information types which helps you to express yourself better than any other exited system. They are sharing the same type declaration.
