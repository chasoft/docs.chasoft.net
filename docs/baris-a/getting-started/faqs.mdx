...
<details>
<summary>Error: Cannot find module '@miniflare/queues' when running `npm run start`</summary>

Some cases, a package missing. And you only need to install it mannually by running the following command in your terminal:

```
npm i @miniflare/queues
```

And try again. This will fix the error for you!
</details>